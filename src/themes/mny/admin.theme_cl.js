...
const theme = {
  "pages": {
      ...
      "styles": [
        {
          ...
          "editControlWrapper": "hidden @[120px]:flex justify-center items-center",
    ...
    "searchButton": {
      ...
      "styles": [
        {
          "name": "mny-responsive",
          "button": "@container flex items-center justify-center @[100px]:justify-between w-10 @[100px]:w-full h-10 mx-auto @[100px]:mx-4 mb-2 @[100px]:mb-4 py-2 @[100px]:px-3 bg-white @[100px]:bg-[#F3F8F9] hover:bg-[#E0EBF0] border border-[#C5D7E0] rounded-full @[100px]:rounded-lg transition ease-in cursor-pointer",
          "buttonText": "hidden @[100px]:inline text-[#37576B] font-['Proxima_Nova'] font-normal text-sm uppercase",
          "iconWrapper": "p-0 @[100px]:p-1.5 @[100px]:bg-[#C5D7E0] @[100px]:rounded-md",
          "icon": "Search",
          "iconClass": "text-[#37576B] @[100px]:text-[#2D3E4C] hover:text-[#2D3E4C]",
          "iconSize": 18
        }
      ]
    },
    "searchPallet": {
      ...
      "styles": [{
        "name": "mny-light",
        "backdrop": "fixed inset-0 bg-black bg-opacity-40 transition-opacity",
        "dialogContainer": "fixed inset-0 z-20 w-screen overflow-y-auto p-4 sm:p-6 md:p-20 flex items-center place-content-center",
        "dialogPanel": "relative max-w-3xl sm:w-[637px] max-h-3/4 sm:h-[700px] p-4 flex flex-col gap-2 overflow-hidden rounded-xl bg-white border border-[#E0EBF0] shadow-xl transition-all",
        "inputWrapper": "w-full flex items-center relative px-4 py-3 bg-[#F3F8F9] rounded-lg border border-[#E0EBF0]",
        "input": "px-1 flex-1 font-['Proxima_Nova'] font-normal text-base text-[#2D3E4C] leading-[140%] bg-transparent focus:ring-0 sm:text-sm rounded-lg ring-0 outline-none placeholder:text-[#37576B]/50",
        "searchIconWrapper": "p-1",
        "searchIcon": "Search",
        "searchIconClass": "text-[#37576B]",
        "resultsWrapper": "bg-[#F3F8F9] rounded-xl px-3 py-4 flex flex-col gap-2 divide-y divide-[#E0EBF0] max-h-[500px] transform-gpu scroll-py-3 overflow-x-hidden overflow-y-auto scrollbar-sm",
        ...
        "pageResultWrapper": "group w-full flex items-center text-xl font-medium text-[#2D3E4C] hover:text-[#37576B] cursor-pointer",
        "pageIcon": "DraftPage",
        "pageIconWidth": 15,
        "pageIconHeight": 21,
        "pageTitle": "pl-2 font-['Oswald'] font-medium text-base leading-[100%] uppercase text-[#2D3E4C]",
        "pageArrowIcon": "ArrowRight",
        "pageArrowClass": "h-6 w-6 ml-2 text-transparent group-hover:text-[#37576B]",
        "sectionsWrapper": "ml-3 pl-4 flex flex-col gap-3 border-l border-[#E0EBF0]",
        "sectionItemWrapper": "w-full cursor-pointer group",
        "sectionTitleWrapper": "w-full flex items-center text-md font-medium text-[#37576B] hover:text-[#2D3E4C]",
        "sectionIcon": "Section",
        "sectionIconWidth": 18,
        "sectionIconHeight": 18,
        "sectionTitle": "pl-1 font-['Proxima_Nova'] font-normal text-base leading-[140%] tracking-normal text-[#37576B]",
        "sectionArrowClass": "h-6 w-6 ml-2 text-transparent group-hover:text-[#2D3E4C]",
        "tagsWrapper": "w-full ml-8",
        "tag": "tracking-wide p-1 text-xs text-white font-semibold rounded-md border",
        "tagMatch": "border-[#EAAD43] bg-[#EAAD43] text-[#2D3E4C]",
        "tagNoMatch": "border-[#C5D7E0] bg-[#E0EBF0] text-[#37576B]",
        "suggestionsWrapper": "flex items-center max-h-96 transform-gpu scroll-py-3 overflow-y-auto p-3",
        "suggestionsLabel": "text-xs italic text-[#37576B]",
        "suggestionItem": "flex cursor-pointer select-none hover:bg-[#E0EBF0] rounded-xl p-1",
        "suggestionTagIcon": "text-xs text-[#EAAD43] fa fa-tag",
        "suggestionTagText": "ml-2 text-sm font-medium text-[#37576B]",
        "suggestionTagTextFocus": "ml-2 text-sm font-medium text-[#2D3E4C]",
        "loadingWrapper": "p-2 mx-auto w-1/4 h-full flex items-center justify-middle",
        "loadingIcon": "px-2 fa fa-loader text-[#37576B]",
        "loadingText": "font-semibold text-[#2D3E4C]",
        "noResultsWrapper": "px-6 py-14 text-center text-sm sm:px-14",
        "noResultsIcon": "fa fa-exclamation mx-auto h-6 w-6 text-[#37576B]",
        "noResultsTitle": "mt-4 font-semibold text-[#2D3E4C]",
        "noResultsText": "mt-2 text-[#37576B]"
      }]
    }
  },
  ...
  "layout": {
    "options": {
      ...
      "sideNav": {
        ...
        "navDepth": "1",
        "navTitle": "flex-1 text-[24px] font-['Oswald'] font-[500] leading-[24px] text-white py-3 px-4 uppercase"
      },
      "topNav": {
        "size": "none",
        "nav": "none",
    ...
    "styles": [
      {
        ...
        "wrapper": "relative isolate flex min-h-svh w-full max-lg:flex-col overflow-hidden",
  ...
  "layoutGroup": {
    ...
    "styles": [
          {
            "name": "default",
            "wrapper1": "w-full h-full flex-1 flex flex-row pt-2 max-w-[990px] mx-auto",
          ...
          {
            "name": "content",
            "wrapper1": "w-full h-full flex-1 flex flex-row lg:py-[10px] md:px-0 max-w-[990px] mx-auto",
          ...
          {
            "name": "darkSection",
            "wrapper1": "w-full h-full flex-1 flex flex-row -my-8 py-10 bg-[linear-gradient(0deg,rgba(33,52,64,.96),rgba(55,87,107,.96)),url('/themes/mny/topolines.png')]  bg-[size:500px] pb-[4px]",
    ...
    "styles": [
      {
        ...
        "layoutContainer2": "hidden scrollbar-sm lg:block fixed top-[10px] left-[10px] bottom-[10px] w-[282px] bg-white rounded-lg shadow-md overflow-y-auto overflow-x-hidden",
        "logoWrapper": "bg-neutral-100 text-slate-800",
        "sidenavWrapper": "hidden md:flex bg-white w-full h-full z-20 flex-col pr-5",
        "menuItemWrapper": "flex-1 flex flex-col",
        ...
        "menuIconSide": "size-5 mr-3 text-[#37576B] flex-shrink-0",
        "menuIconSideActive": "size-5 mr-3 text-[#2D3E4C] flex-shrink-0",
      ...
      },
      {
        ...
        "menuIconSide": "size-6 text-[#37576B]",
        "menuIconSideActive": "size-6 text-[#37576B]",
        "forcedIcon": "",
        ...
        "navItemContent_level_1": "hidden",
        "navItemContent_level_2": "block text-[16px] font-['Proxima_Nova'] font-[600] leading-[19.2px] text-[#37576B] py-2",
        "navItemContent_level_3": "block text-[14px] font-['Proxima_Nova'] font-[400] leading-[19.6px] text-[#37576B] py-2",
        ...
        "navitemSide_level_2": "w-full group flex flex-row items-center px-4 py-2 focus:outline-none transition-all cursor-pointer hover:bg-[#E0EBF0]",
        "navitemSideActive_level_2": "w-full group flex flex-row items-center px-4 py-2 focus:outline-none transition-all cursor-pointer bg-[#E0EBF0]",
  ...
  "logo": {
    ...
    "logoAltImg": "/themes/mny/nys_logo_blue.svg",
    "logoAltImgClass": "h-10 w-auto @[100px]:hidden",
    "imgWrapper": "h-12 pl-3 pr-2 flex items-center justify-center @[100px]:justify-start",
    "img": "https://mitigateny.org/themes/mny/mnyLogo.svg",
    "imgClass": "h-12 w-auto hidden @[100px]:block",
    "titleWrapper": "",
    "title": "",
    "linkPath": "/"
  },
  ...
  "dialog": {
    ...
    "dialogPanel": "row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-[--gutter] shadow-lg ring-1 ring-zinc-950/10 [--gutter:theme(spacing.8)] sm:mb-auto sm:rounded-2xl dark:bg-zinc-900 dark:ring-white/10 forced-colors:outline transition duration-100 data-[closed]:translate-y-12 data-[closed]:opacity-0 data-[enter]:ease-out data-[leave]:ease-in sm:data-[closed]:translate-y-0 sm:data-[closed]:data-[enter]:scale-95 z-10 p-2",
    "sizes": {
      "xs": "sm:max-w-xs",
      "sm": "sm:max-w-sm",
      "md": "sm:max-w-md",
  ...
  "lexical": {
    ...
    "heading": {
      "h1": "font-[500]  text-[#2D3E4C] text-[36px] leading-[140%] tracking-[-.02em] font-[500] underline-offset-8 underline decoration-4 decoration-[#EAAD43] uppercase font-['Oswald'] pb-[12px]",
