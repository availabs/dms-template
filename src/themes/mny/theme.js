    ...
    styles: [
      {
        ...
        // 240, not 258: the LHMP focus card and the hazard bar list sit side by side in
        // the same band, and the client asked for their heights balanced now that the
        // "<hazard> profile" pill has come off the card. Measured on /home at 1440:
        // focus grid 408px vs graph grid 390px, and the 18px delta is exactly this image.
