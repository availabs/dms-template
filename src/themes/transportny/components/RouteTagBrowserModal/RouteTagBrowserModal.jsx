...
import { TAG_CATEGORIES, AUTO_GENERATED_TAG } from './tagCategories';
        ...
        <div className={t.body}>
          {view === 'root' ? (
            <>
              ...
              <div className={t.categoryGrid}>
                {TAG_CATEGORIES.map((c) => (
                  <button key={c.key} type="button" className={t.categoryTile} onClick={() => goCategory(c.key)}>
                    <span className={t.categoryTileLabel}>{c.label}</span>
                    <span className={t.categoryTileHint}>{c.values.length} values</span>
                  </button>
                ))}
                <button type="button" className={t.categoryTile} onClick={goAutoGenerated}>
                  <span className={t.categoryTileLabel}>Auto-generated</span>
                  <span className={t.categoryTileHint}>system-generated routes</span>
                </button>
                <button type="button" className={t.categoryTile} onClick={goOther}>
                  <span className={t.categoryTileLabel}>Other tags</span>
                  <span className={t.categoryTileHint}>project #s, custom tags</span>
                </button>
              </div>
            </>
          ) : null}
