...
export async function resolveClosureDensityPoints(ogcFid, pgEnv, numCandidates, costObjective = "distance") {
...
export async function resolveClosureDensityRoutes(ogcFid, pgEnv, startNodeIds, endNodeIds, costObjective = "distance") {
