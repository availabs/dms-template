...
CLI:
  python3 src/themes/transportny/scripts/dbq.py old "SELECT count(*) FROM admin2.reports"
  python3 src/themes/transportny/scripts/dbq.py new "SELECT id, type FROM dms_npmrdsv5.data_items LIMIT 5" --csv
  python3 src/themes/transportny/scripts/dbq.py ch  "SELECT count() FROM npmrds.s583_v982_NPMRDS_V6"
  python3 src/themes/transportny/scripts/dbq.py ch  "DESCRIBE npmrds.s583_v982_NPMRDS_V6" --format PrettyCompact
  python3 src/themes/transportny/scripts/dbq.py old -f peek.sql          # SQL from file
  echo "SELECT 1" | python3 src/themes/transportny/scripts/dbq.py dama -  # SQL from stdin
  python3 src/themes/transportny/scripts/dbq.py graph '[["dms","data","npmrdsv5+dev2:site","length"]]'
