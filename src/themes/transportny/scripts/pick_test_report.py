...
Usage:
  python3 src/themes/transportny/scripts/pick_test_report.py                  # one random slug + full URL
  python3 src/themes/transportny/scripts/pick_test_report.py --count 5         # 5 random slugs
  python3 src/themes/transportny/scripts/pick_test_report.py --search "bridge" # random match containing "bridge"
  python3 src/themes/transportny/scripts/pick_test_report.py --list 20         # list 20 (id, slug, title), no randomness
"""
import argparse
import os
import sys
