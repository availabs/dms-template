...
Usage:
  python3 src/themes/transportny/scripts/route_gen_corridors.py 2024 --out spec_2024.json
  python3 src/themes/transportny/scripts/route_gen_corridors.py 2024 --regions 1,11
"""
import argparse
import json
import os
