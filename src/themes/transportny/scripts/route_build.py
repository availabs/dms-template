...
Usage:
  python3 src/themes/transportny/scripts/route_build.py find --road 9D --county DUTCHESS
  python3 src/themes/transportny/scripts/route_build.py find --road 9D --direction NORTHBOUND \
      --from-intersection 'MAIN ST' --to-intersection 'I-84'
  python3 src/themes/transportny/scripts/route_build.py build myroutes.json --dry-run
  python3 src/themes/transportny/scripts/route_build.py build myroutes.json
