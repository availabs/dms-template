...
//
// Usage:
//   node src/themes/transportny/scripts/report_probe.mjs <slug-or-full-url> [options]
//
// Examples:
//   node src/themes/transportny/scripts/report_probe.mjs report_1070
//   node src/themes/transportny/scripts/report_probe.mjs report_1070 --grep hours_of_delay --wait 10000
//   node src/themes/transportny/scripts/report_probe.mjs report_796 --section "Travel Time" --no-json
//   node src/themes/transportny/scripts/report_probe.mjs report_11 --eval scratchpad/npmrds-sub/tmp/my_probe.mjs
//
// Options:
...
if (!target || target.startsWith('--')) {
  console.error('usage: node src/themes/transportny/scripts/report_probe.mjs <slug-or-url> [--wait ms] [--grep s]... [see header]');
  process.exit(2);
}
const opts = {
