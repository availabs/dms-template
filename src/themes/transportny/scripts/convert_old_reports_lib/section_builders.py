...
def build_graph_section_data(page_id, tmpl, tracking_id, info, gaps, old_graph,
    ...
    if is_self_bound:
        ...
        # "display._measurePick.routeIds" (src/themes/transportny/scripts/report_probe_fixtures/
        # golden-corpus.json) needs re-verifying — `node src/themes/transportny/scripts/
