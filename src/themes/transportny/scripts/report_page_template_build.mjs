 ...
 *
 *   node src/themes/transportny/scripts/report_page_template_build.mjs [--dry-run|--apply]
 *
...
const SPECS_DIR = resolve(REPO, 'src/themes/transportny/scripts/page_template_specs');
...
if (!APPLY && !DRY_RUN) {
  console.error('usage: node src/themes/transportny/scripts/report_page_template_build.mjs [--dry-run|--apply]');
  process.exit(2);
}
