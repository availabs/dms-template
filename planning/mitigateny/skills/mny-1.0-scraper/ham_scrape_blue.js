// Scrape the per-hazard jurisdiction "blue box" narrative for ONE Hamilton jurisdiction.
// blue box = div.element-box (aliceblue) headed "<Juris> Jurisdictional Annex". Fresh browser.
