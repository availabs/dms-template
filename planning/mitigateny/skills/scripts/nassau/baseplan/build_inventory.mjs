...
fs.writeFileSync(OUT+'inventory.json',JSON.stringify(inv,null,1));
fs.writeFileSync(OUT+'all_components.json',JSON.stringify(allComps,null,1));
...
fs.writeFileSync(OUT+'inventory.md',md);
